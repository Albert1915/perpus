...
<body class="hold-transition login-page" style="overflow-y: hidden;background:url(
	'<?php echo base_url('assets_style/image/library.jpg');?>')no-repeat;background-size:100%;">
<div class="login-box">
	<br/>
  <div class="login-logo">
    <a href="index.php" style="color: black;">Welcome To <br/><b>Manga Wibs</b></a>
  </div>
  <div id="tampilalert"></div>
  <!-- /.login-logo -->
  <div class="login-box-body" style="border:2px solid #0F1035;">
    <p class="login-box-msg" style="font-size:16px;"></p>
    <form action="<?= base_url('login/auth');?>" method="POST">
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="Username" id="user" name="user" required="required" autocomplete="on">
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="password" class="form-control" placeholder="Password" id="pass" name="pass" required="required" autocomplete="on">
      ...
      <div class="row">
        ...
        <div class="col-xs-4">
          <button type="submit" id="loding" class="btn btn-black btn-block btn-flat">Sign In</button>
  ...
  <!-- /.login-box-body -->
  <br/>
  <footer style="background-color: #3334; color: #fff; padding: 20px; text-align: center; font-family: Arial, sans-serif;">
    <div class="login-box-body text-center bg-black" style="padding: 10px; border-radius: 8px;">
        <p style="color: white; font-size: 16px; margin-bottom: 5px;">&copy; <span id="currentYear"></span> Albert Okario</p>
    </div>
</footer>
</div>
<!-- /.login-box -->
